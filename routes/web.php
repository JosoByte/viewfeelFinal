...
Route::get('/chat', 'App\Http\Controllers\Controller@chatIndex')->name('chat');
...
Route::post('/removeLike/{artistName}/{artIndex}', 'App\Http\Controllers\Controller@removeLike');
